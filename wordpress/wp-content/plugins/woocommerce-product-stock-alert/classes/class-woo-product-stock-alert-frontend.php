...
class WOO_Product_Stock_Alert_Frontend {
	...
	function get_alert_form() {
		...
		$alert_success = $alert_email_exist = $valid_email = '';
		...
		if( empty($alert_email_exist) ) {
			$alert_email_exist = __( '<b>%customer_email%</b> is already registered with <b>%product_title%</b>. Please try again.', $WOO_Product_Stock_Alert->text_domain );
		}
